...
def apply_tooltips(window: Any) -> None:
    ...
    window.settings_action.setToolTip("Open the settings dialog. It contains DB/source paths, matching terms, scrape concurrency, Hacker News parser mode, and Local AI settings.")
